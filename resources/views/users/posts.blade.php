        ...
        <div class="col-3 mt-4 mb-2 jumbotron-home text-white px-0">
            ...
            <div class="text-center mt-4 pb-5">
                <ul class="nav flex-column nav-pills"  role="tablist" aria-orientation="vertical">
                    ...
                    <li class="nav-item active"><a href="{{ route('users.posts', ['id' => $user->id]) }}" class="nav-link" style="color: white;"> POSTS <span class="badge badge-warning badge-pill">{{$posts->count()}}</span></a></li>
